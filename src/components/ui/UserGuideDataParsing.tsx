      ...
      <CardContent className="pt-2">
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="upload">
            <AccordionTrigger className="text-md font-medium">Upload</AccordionTrigger>
            <AccordionContent className="space-y-4 mt-2">
              <div>
          ...
          <AccordionItem value="parsing">
            <AccordionTrigger className="text-md font-medium">Parsing</AccordionTrigger>
            <AccordionContent className="space-y-4 mt-2">
              <div>
          ...
          <AccordionItem value="conversion">
            <AccordionTrigger className="text-md font-medium">Conversion</AccordionTrigger>
            <AccordionContent className="space-y-4 mt-2">
              <div>
