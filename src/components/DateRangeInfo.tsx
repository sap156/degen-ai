...
const DateRangeInfo: React.FC<DateRangeInfoProps> = ({
  ...
  // Add time portion to date format for hourly intervals
  const dateFormat = interval === 'hourly' ? 'PPp' : 'PP';
    ...
    <div className="bg-muted/30 p-3 rounded-md flex items-start space-x-3">
      ...
      <div>
        ...
        <p className="text-xs text-muted-foreground mt-1">
          From {format(startDate, dateFormat)} to {format(endDate, dateFormat)}
