    ...
    <Card className="h-full overflow-hidden border border-border/40 hover:border-border/80 transition-all">
      ...
      <CardFooter className="pt-2">
        <Link to={feature.path} className="w-full">
          <Button 
            variant="ghost" 
            className="flex items-center justify-between w-full bg-secondary/50 hover:bg-secondary"
          >
            <span>Explore</span>
  ...
  return (
    <div className="container px-4 mx-auto py-8 max-w-7xl">
      <div className="flex flex-col items-center text-center mb-16 space-y-3">
        ...
        <motion.h1 
          className="text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight max-w-3xl"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
